...
app.layout = html.Div([
    # TASK 2.1: Fixed style formatting (fontSize)
    html.H1("Automobile Sales Statistics Dashboard", 
            style={'textAlign': 'center', 'fontSize': '24px', 'color': '#503D36'}),
...
def update_output_container(selected_statistics, year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart2 = dcc.Graph(
            figure=px.bar(average_sales,
                           x='Vehicle_Type',
                           y='Automobile_Sales',
                           title="Average Number of vehicle sold for each vehicle type in Recession Period"))
    ...
    # TASK 2.6: Fixed input_year typos to match parameter name 'year'
        ...
        Y_chart1 = dcc.Graph(
            figure=px.line(yas,
                           x='Year',
                           y='Automobile_Sales',
                           title='Average Sales for each Year'))
        ...
        # Fixed the structural parenthesis bug and formatting variable here
        ...
        Y_chart4 = dcc.Graph(
            figure=px.pie(exp_data,
                           values='Advertising_Expenditure',
                           names='Vehicle_Type',
                           title='Advertising Expenditure for Each Vehicle type in {}'.format(year)))
